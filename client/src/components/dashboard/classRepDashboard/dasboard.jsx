...
export default function Dashboard() {
    ...
    return(
        <div>
            <div className="flex flex-col md:flex-row lg:flex-row gap-5 items-center justify-between shadow-xl p-5 border rounded-xl w-[100%] bg-purple-100">
            ...
            <nav className="m-5">
                <ul className="flex gap-2 md:gap-5 lg:gap-5 flex-row items-center justify-center w-[100%]">
                    <li className="bg-green-300 hover:bg-green-400 p-2 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition easeinout duration-500 cursor-pointer w-[30%] md:w-50 lg:w-70">
